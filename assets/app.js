const MENU = [
    ...
    const I18N = {
      sq:{
        ...
        fresh_kitchen:"Nga kuzhina",takeaway:"Për me vete",story_label:"Historia jonë",
        story_quote:'Dashuria vjen nga <span class="yellow">stomaku.</span>',
        story_body:'<p class="story-body">Historia e Piccolino Pizza nisi shumë përpara se të hapnim dyert tona në Korçë. Pas më shumë se 15 vitesh përvojë në Greqi në artin e përgatitjes së picës dhe në mikpritje, në vitin 2016 vendosëm ta sillnim këtë përvojë në Shqipëri.</p><p class="story-body">Me mbështetjen dhe kontributin e familjes, Piccolino lindi si një biznes familjar, i ndërtuar mbi përkushtimin, cilësinë dhe dashurinë për ushqimin e mirë.</p><p class="story-body">Që nga dita e parë, kemi qëndruar besnikë ndaj të njëjtave vlera: përbërës cilësorë, përgatitje me kujdes dhe shërbim i sinqertë për çdo klient.</p><p class="story-body">Sot, vazhdojmë të rritemi falë besimit dhe mbështetjes suaj.</p><p class="serif">Piccolino — përvojë e fituar ndër vite, e sjellë në zemër të Korçës që prej vitit 2016.</p>',
      ...
      en:{
        ...
        fresh_kitchen:"From the kitchen",takeaway:"To go",story_label:"Our story",
        story_quote:'The way to the heart is through the <span class="yellow">stomach.</span>',
        story_body:'<p class="story-body">The story of Piccolino Pizza began long before we opened our doors in Korçë. After more than 15 years of experience in Greece in the art of pizza-making and hospitality, we decided to bring that expertise to Albania in 2016.</p><p class="story-body">With the support and contribution of our family, Piccolino was established as a family-run business built on dedication, quality, and a genuine love of good food.</p><p class="story-body">From the very beginning, we have remained true to the same values: quality ingredients, careful preparation, and sincere service for every customer.</p><p class="story-body">Today, we continue to grow thanks to your trust and support.</p><p class="serif">Piccolino — experience developed over the years, brought to the heart of Korçë in 2016.</p>',
